...
BAIT_DATA = [
    ...
    (
        ...
        1.0,
        True,
    ),  # garbage_reduction_modifier = 0.8 (80%几率)
    # --- Rarity 4 (稀有) ---
    (
        "秘制香饵",
        "用特殊配方制成，对稀有鱼类极具诱惑力。",
    ...
    (
        ...
        1.0,
        True,
    ),  # (注: 重量潜力加成需在fishing_service中单独处理)
    (
        "丰饶号角粉末",
        "从丰收号角上刮下来的一点粉末。",
        5,
